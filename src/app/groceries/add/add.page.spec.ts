...
describe('AddPage', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    groceryServiceSpy = jasmine.createSpyObj('IGroceryService', ['addGrocery','toggleGrocerySelection', 'getGroceries']);
  ...
  it('should add grocery',async ()=>{
    ...
    expect(groceryServiceSpy.addGrocery).toHaveBeenCalled();
  });
});
